...
- The bundled sort UI keeps normal activation single-column and adds Shift-modified secondary sorting with ordered priority descriptions for accessible multi-sort state.
